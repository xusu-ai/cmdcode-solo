...
```
cmdcode-solo/
├── ui.html                        # 完整前端 Agent，含记忆检索（~293KB）
...
| 文件 | 大小 | 描述 |
|:----|:----|:------|
| **ui.html** | ~293 KB | 前端聊天界面，零框架依赖。内置 AI Agent 对话、文件管理器、图片查看器、音视频播放、用户认证、模型选择设置面板、多模态工具（文生图/视频/音乐/语音）、3 Key 限流轮换、会话级配额耗尽保护 |
...
核心应用代码（HTML + CSS + JS）约 293KB，适合学习原生 Web 开发或作为轻量级 AI 应用基座。
